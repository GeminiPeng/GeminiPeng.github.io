---
layout: post
title: "第一篇博客(Jekyll搭建个人博客)"
date: 2016-12-05 
description: "Jekyll的配置,github-pages设置，搭建自己的博客"
tag: 博客 
---   

　　随着时间的积累,浏览器的书签是越来越多,看过的好文章收藏后就全都尘封在收藏夹了,所以决定自己弄一个博客来管理这些文章,家穷买不起服务器(开玩笑啦!)只是觉得没太大必要,只是想存一些文章而已,域名我都用的免费的(丑点就丑点吧)以后再换,这是第一篇,就把我搭建的过程记录一下吧.
 

## 正文：
　本文参照了(潘柏信)的个人博客文章,我是按照他的介绍一步步搭建完成,那就把这篇文章记录下来吧!
...
```    
$ jekyll new myBlog  (在这里可能会报错,需要先安装bundle,后面再对错误进行解释)  
```   
...
　我这里讲的是部署到 Github Page 创建一个 github 账号，然后创建一个跟你账户名一样的仓库，如我的 github 账户名叫 [leopardpan](https://github.com/leopardpan)，我的 github 仓库名就叫 [leopardpan.github.io](https://github.com/leopardpan/leopardpan.github.io)，创建好了之后，把刚才建立的 myBlog 项目 push 到 username.github.io仓库里去（username指的是你的github用户名），检查你远端仓库已经跟你本地 myBlog 同步了，这里还要生成一下域名(仓库名->Setting->GitHub Pages(Update site))设置完成后github会自动生成html.css.js文件,需要替换成我们的html重新push,然后你在浏览器里输入 username.github.io ，就可以访问你的博客了。
...
首先你要获取的原博主的博客，[Github项目地址](https://github.com/leopardpan/leopardpan.github.io.git)，你可以直接[点击下载博客](https://github.com/leopardpan/leopardpan.github.io/archive/master.zip)，进去leopardpan.github.io/ 目录下， 使用命令部署本地服务 
...
在浏览器输入 [127.0.0.1:4000](127.0.0.1:4000) ， 就可以看到[abcdpengbo123.github.io](http://abcdpengbo123.github.io)博客效果了。

### 修改成你自己的博客

>* 如果你想使用我的模板请把 _posts/ 目录下的文章都去掉,其他的都可以引用。
...
转载地址，潘柏信的博客：[http://leopardpan.github.io](http://leopardpan.github.io) 谢谢！
